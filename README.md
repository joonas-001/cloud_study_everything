...
| GitHub Issues 提交入口 | 已创建并置顶 | [Issue #26“提交issues请看这里”](https://github.com/joonas-001/cloud_study_everything/issues/26) 提供 Bug、Feature Request、Other 三栏即时预填模板，分别附加 `bug`、`enhancement`、`question` 标签；其他远程治理配置仍须单独授权 |
...
[`docs/architecture/milestone-8g-validation.md`](docs/architecture/milestone-8g-validation.md)。
