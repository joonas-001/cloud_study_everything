...
| 第八里程碑 8A–8G | 8A–8C 当前授权范围已完成 | 8B 增加通用契约和关闭入口的 `algorithm@0.3.0` 草稿：12 域、46 能力、34 单元、64 题及 22 个双语言 Runner 定义；8C 实现完全确定性的自适应选题、三态路径信号、预算停止、解释审计、修正重算、恢复、重放和受管回退。历史版本、默认入口、数据库 Schema、依赖和运行状态未改；远程来源复核、第二评审、真实 Runner 复验已写入 TODO。8D–8G 未授权 |
