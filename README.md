...
| 第六里程碑 6A | 本地修复已实现，待正式交付 | 已确认新加坡单实例、Microsoft 白名单、Tailscale 私有入口、¥50 硬上限、SQLite、禁用远程 Runner、加密备份和 7 天日志；已补 Web/API 双层身份门禁、受控启动器和检查清洁度，仍须完成当前工作区完整门禁、提交、PR、远程 CI 和合并 |
